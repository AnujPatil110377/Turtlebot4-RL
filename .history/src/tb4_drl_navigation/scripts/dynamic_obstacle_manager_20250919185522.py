#!/usr/bin/env python3
"""
Dynamic Obstacle Manager for TurtleBot4 RL Environment.

This node manages dynamic obstacles in the Gazebo simulation, providing
realistic moving obstacles for training navigation algorithms.
